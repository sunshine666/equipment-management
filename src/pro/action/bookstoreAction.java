...
public class bookstoreAction  extends ActionSupport{
	...
	{
		this.bookstoreList=bsd.getBookstoreList(this.b.getBookISBN(), this.b.getBookName(), String.valueOf(this.b.getPublisherID()), String.valueOf(this.b.getCategoryID()),this.b.getUnit(),ActionContext.getContext().getSession().get("roleId").toString());
		return SUCCESS;
	}
